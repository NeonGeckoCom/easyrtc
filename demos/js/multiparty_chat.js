...
function reshape1of7(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*4)/5,
        top: (parenth - sharedVideoHeight*2)/3,
        width: sharedVideoWidth,
        height: sharedVideoHeight
    }
...
function reshape2of7(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*4)/5*2+ sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3,
        width: sharedVideoWidth,
        height: sharedVideoHeight
    }
...
function reshape3of7(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*4)/5*3+ sharedVideoWidth*2,
        top: (parenth - sharedVideoHeight*2)/3,
        width: sharedVideoWidth,
        height: sharedVideoHeight
    }
...
function reshape4of7(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*4)/5*4+ sharedVideoWidth*3,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
        height: sharedVideoHeight
    }
...
function updateMuteImage(toggle) {
    ...
    if( activeBox > 0) { // no kill button for self video
        ...
        muteButton.src = isMuted?"/easyrtc/demos/images/button_unmute.png":"/easyrtc/demos/images/button_mute.png";
...
function showMessage(startX, startY, content) {
    ...
    cloudObject.src = "/easyrtc/demos/images/cloud.png";
